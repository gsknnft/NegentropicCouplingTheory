import { cosineSimilarity } from "../packages/coherence/invariants";

export function metaObserver(
  prev: { metaEigen: { eigenvectors: number[][] } },
  current: {
    metaEigen: { eigenvectors: number[][]; varianceExplained: any[] };
  },
) {
